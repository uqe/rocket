...
const generateSentence = (): string => {
  const wordsCountInSentence = Math.floor(Math.random() * (7 - 2 + 1)) + 2 // 7 is max and 2 is min
  const words = new Array(wordsCountInSentence).fill(null).map(() => dict[Math.floor(Math.random() * dict.length)])
